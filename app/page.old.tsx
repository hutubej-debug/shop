    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex justify-center gap-4">
          ...
          <Link
            href="/settings"
            className="inline-flex items-center px-6 py-3 bg-gray-600 text-white text-lg font-semibold rounded-lg shadow-lg hover:bg-gray-700 transition-all transform hover:scale-105"
          >
            ⚙️ Settings
          </Link>
        </div>
